var ExFunction = [{
			...
			"Args": ["values", "timeline", "[datacompletion]", "[aggregation]"]
		},
		{
			...
			"Args": ["target_date", "values", "timeline", "[confidence_level]", "[seasonality]", "[datacompletion]", "[aggregation]"]
		},
		{
			"Fname": "FORECAST.ETS.STAT",
			"NewLine": "Yes",
			"Des": "calculates the length of a repetitive pattern in a timeline.",
			"Args": ["values", "timeline", "statistic_type", "[seasonality]", "[datacompletion]", "[aggregation]"]
		},
		{
		...
		},
		{
			...
			"Args": ["target_date", "values", "timeline", "[seasonality]", "[datacompletion]", "[aggregation]"]
		},
		{
			"Fname": "GETPIVOTDATA",
			"NewLine": "Yes",
			"Des": "tests whether a supplied number is greater than a supplied step size and returns:",
			"Args": ["data_field", "pivot_table", "[field1]", "[item1]", "[field2]", "[item2]"]
		},
		{
			"Fname": "HYPGEOM.DIST",
			"NewLine": "Yes",
		...
		},
		{
			...
			"Args": ["average_range", "criteria_range1", "criteria1", "[criteria_range2", "criteria2]"]
		},
		{
			"Fname": "BINOM.DIST",
			"NewLine": "Yes",
		...
		},
		{
			...
			"Args": ["x", "degrees_freedom", "cumulative"]
		},
		{
			"Fname": "CHISQ.TEST",
			"NewLine": "Yes",
		...
		},
		{
			...
			"Args": ["settlement", "maturity", "issue", "first_coupon", "rate", "yld", "redemption", "frequency", " [basis] )"]
		},
		{
			"Fname": "ODDFYIELD",
			"NewLine": "Yes",
			"Des": "calculates the yield of a security with an odd (short or long) first period.",
			"Args": ["settlement", "maturity", "issue", "first_coupon", "rate", "pr", "redemption", "frequency", " [basis] )"]
		},
		{
			"Fname": "ODDFYIELD",
			"NewLine": "Yes",
		...
		},
		{
			...
			"Args": ["settlement", "maturity", "last_interest", "rate", "yld", "redemption", "frequency", "[basis]"]
		},
		{
			"Fname": "PDURATION",
			"NewLine": "Yes",
		...
		},
		{
			...
			"Args": ["criteria_range1", "criteria1", "[criteria_range2", "criteria2]"]
		},
		{
			"Fname": "COUPDAYS",
			"NewLine": "Yes",
		...
		},
		{
			...
			"Args": ["issue", "first_interest", "settlement", "rate", "[par]", "frequency", "[basis]", "[calc_method]"]
		},
		{
			"Fname": "ADDRESS",
			"NewLine": "Yes",
		...
		},
		{
			...
			"Args": ["known_y's", "[known_x's]", "[new_x's]", "[const]"]
		},
		{
			"Fname": "IMCOSH",
			"NewLine": "No",
		...
		},
		{
			...
			"Args": ["known_y's", "[known_x's]", "[const]", "[stats]"]
		},
		{
			"Fname": "LOGINV",
			"NewLine": "Yes",
		...
		},
		{
			...
			"Args": ["search_text", "within_text", "[start_num]"]
		},
		{
			"Fname": "SECOND",
			"NewLine": "No",
		...
		},
		{
			...
			"Args": ["expression", " value1", " result1", " [value2", " result2]", " [value3", " result3]", " [default] )"]
		},
		{
			"Fname": "T.DIST",
			"NewLine": "Yes",
		...
		},
		{
			"Fname": "INDEX",
			"NewLine": "Yes",
			"Des": "Returns the value or reference of a specific row and column crossing cell in a given cell range",
			"Args": ["Cell range", "Line serial number", "Column number"]
		},
		{
			"Fname": "MAXA",
			"NewLine": "Yes",
		...
		},
		{
			...
			"Args": ["logical_test1", "[logical_test2]"]
		},
		{
			"Fname": "COS",
			"NewLine": "No",
		...
		},
		{
			...
			"Args": ["logical_test1", " value_if_true1", " [logical_test2", " value_if_true2]", " [logical_test3", " value_if_true3]"]
		},
		{
			"Fname": "INT",
			"NewLine": "No",
		...
		},
		{
			...
			"Args": ["rate", "value1", "[value2]", "[value3]"]
		},
		{
			"Fname": "ODD",
			"NewLine": "No",
